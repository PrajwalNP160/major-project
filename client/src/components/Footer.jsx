        ...
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            ...
            <div className="flex mt-8 space-x-6">
              <a
                href="#"
                className="text-gray-500 dark:text-gray-400 hover:text-teal-600 dark:hover:text-teal-500 transition-colors duration-200"
              >
                <Twitter size={20} />
            ...
            <div>
              ...
              <ul className="mt-4 space-y-4">
                <li>
                  <Link
                    to="/"
                    className="text-sm text-gray-600 dark:text-gray-400 hover:text-teal-600 dark:hover:text-teal-500 transition-colors duration-200"
                  >
                    Features
                  </Link>
                </li>
